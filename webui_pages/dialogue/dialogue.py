...
import re
import time
from configs import (TEMPERATURE, TOP_P, FREQUENCY_PENALTY, HISTORY_LEN, PROMPT_TEMPLATES, LLM_MODELS,
...
def dialogue_page(api: ApiRequest, is_lite: bool = False):
    ...
    with st.sidebar:
        ...
        # top_p = st.slider("Top P：",0.0,1.0,TOP_P,0.05)
        # frequency_penalty = st.slider("Frequency Penalty",-2.0,2.0,FREQUENCY_PENALTY,0.05)
        temperature = st.slider("Temperature:", 0.0, 2.0, TEMPERATURE, 0.05, key="slider_temperature")
        # top_p = st.slider("Top P:", 0.0, 1.0, TOP_P, 0.05, key="slider_top_p")
        frequency_penalty = st.slider("Frequency Penalty", -2.0, 2.0, FREQUENCY_PENALTY, 0.05,
                                      key="slider_frequency_penalty")
