...
from configs.model_config import RERANKER_MAX_LENGTH
...
class LangchainReranker(BaseDocumentCompressor):
    ...
    def compress_documents(
        ...
        _docs = [d.page_content[:RERANKER_MAX_LENGTH] if len(d.page_content) > RERANKER_MAX_LENGTH else d.page_content for d in doc_list]
        ...
        for value, index in zip(values, indices):
            doc = doc_list[index]
            doc.page_content = doc.page_content[:RERANKER_MAX_LENGTH]
